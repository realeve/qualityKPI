...
let actions = {
  ...
  printScore(store) {
    ...
    let curScore =
      store.getters.goodRateScore.score +
      store.getters.openNumScore.score +
      store.getters.plateScore.score +
      store.getters.machineWeak.score +
      store.getters.fakeRate.score +
      store.getters.uncheckedScore.score +
      store.getters.questionScore.score +
      store.getters.riskScore.score +
      store.getters.qfjScore.score +
      store.getters.SPCScore.score; // + store.getters.procRateScore.score
  ...
  paperScore(store) {
    ...
    let curScore =
      store.getters.pGoodRateScore.score +
      store.getters.cGoodRateScore.score +
      store.getters.pkgRateScore.score +
      store.getters.rePkgRateScore.score +
      store.getters.abnormalScore.score +
      store.getters.pQuestionScore.score +
      store.getters.PSPCScore.score;
  ...
  getDashboardPrintGoodrate(store) {
    ...
    axios
      .get(api.dashboard.print.goodrate, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardPaperGoodrate(store) {
    ...
    axios
      .get(api.dashboard.paper.goodrate, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardOpennum(store) {
    ...
    axios
      .get(api.dashboard.print.opennum, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardAbnormal(store) {
    ...
    axios
      .get(api.dashboard.paper.abnormal, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardNocheck(store) {
    ...
    axios
      .get(api.dashboard.print.nocheck, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardPkgRate(store) {
    ...
    axios
      .get(api.dashboard.paper.packagerate, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardQuestion(store) {
    ...
    axios
      .get(api.dashboard.print.question, {
        params
      })
      .then(res => {
  ...
  getDashboardPaperReason(store) {
    ...
    axios
      .get(api.dashboard.paper.reason, {
        params: util.getDateRange()
      })
      .then(res => {
  ...
  getDashboardProdNum(store) {
    ...
    axios
      .get(api.dashboard.print.prodnum, {
        params: util.getDateRange()
      })
      .then(res => {
